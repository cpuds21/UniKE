...
# :py:class:`unike.module.model.ComplEx`，它是第一个真正意义上的复数域模型。
...
######################################################################
# .. Note:: 上述代码的运行日志可以从 `此处 </zh-cn/latest/_static/logs/examples/ComplEx/single_gpu_complex_WN18RR_wandb.txt>`_ 下载。
# .. Note:: 上述代码的运行报告可以从 `此处 </zh-cn/latest/_static/pdfs/examples/ComplEx/ComplEx单卡训练示例（一）.pdf>`_ 下载。
