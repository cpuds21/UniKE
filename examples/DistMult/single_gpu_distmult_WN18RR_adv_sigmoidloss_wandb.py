...
# :py:class:`unike.module.model.DistMult`，它是最简单的双线性模型。
...
######################################################################
# .. Note:: 上述代码的运行日志可以从 `此处 </zh-cn/latest/_static/logs/examples/DistMult/single_gpu_distmult_WN18RR_adv_sigmoidloss_wandb.txt>`_ 下载。
# .. Note:: 上述代码的运行报告可以从 `此处 </zh-cn/latest/_static/pdfs/examples/DistMult/DistMult单卡训练示例（二）.pdf>`_ 下载。
